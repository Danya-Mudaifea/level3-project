...
push-images: 
	...
	kubectl delete -f ./tekton/tasks/build-push-task.yaml -n test
	kubectl delete -f ./tekton/tasks/deploy-task.yaml -n test
	...
	kubectl delete -f ./tekton/tasks/run-e2e.yaml -n test
	kubectl delete -f ./tekton/pipeline/pipeline-e2e-js-test.yaml -n  test
	kubectl delete -f ./tekton/pipelinerun/PipelineRun-e2e-js-test.yaml -n  test
